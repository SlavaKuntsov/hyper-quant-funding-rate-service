...
public class HyperLiquidFundingRateOnlineSyncJob(
    ILogger<HyperLiquidFundingRateOnlineSyncJob> logger,
    IHyperLiquidRestClient hyperLiquidClient,
    IExchangeRepository exchangeRepository,
    IFundingRateOnlineRepository fundingRateOnlineRepository,
    IUnitOfWork unitOfWork)
    : BaseFundingRateOnlineSyncJob<HyperLiquidFundingRateOnlineSyncJob>(
